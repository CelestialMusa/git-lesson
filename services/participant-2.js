/**
 * Participant 2 — Service Definition
 *
 * Instructions:
 * Find the YOUR TASK comment below and make your changes there.
 * This file belongs to Participant 2 — only you should edit it.
 */

const service = {
  id: "participant-2",
  name: "Participant 2 Service",
  ...
  owner: Unathi, // Add your name here too if you like
};
